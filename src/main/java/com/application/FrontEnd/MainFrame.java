...
public class MainFrame extends JFrame {
    ...
    // In MainFrame.java
    // In MainFrame.java
// Ensure this import is present: import java.util.List;
    public void switchToChatRoom(String currentUsername, String currentRoomName, java.util.List<String> initialUsersInRoom) { // Use java.util.List<String>
        System.out.println("[MainFrame] Switching to ChatRoom for user: " + currentUsername + " in room: " + currentRoomName);

        if (chatRoom == null) {
            System.out.println("ChatRoom instance is null in switchToChatRoom. Creating new instance.");
            chatRoom = new ChatRoom(currentUsername, currentRoomName, this, chatController);
            mainViewPanel.add(chatRoom, CHAT_ROOM_CARD);
        }
        // No cast needed here if the signature is correct
        chatRoom.reInitializeForNewSession(currentUsername, currentRoomName, initialUsersInRoom);
        ...
        System.out.println("[MainFrame] Switched to ChatRoom. Current users provided: " + (initialUsersInRoom != null ? initialUsersInRoom.size() : "null list"));
    }
